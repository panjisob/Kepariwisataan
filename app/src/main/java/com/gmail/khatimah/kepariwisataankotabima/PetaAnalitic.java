...
public class PetaAnalitic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_analitic);
    ...
    private class MapAdapter extends RecyclerView.Adapter<MapAdapter.ViewHolder> {
        ...
        /**
         * Holder for Views used in the {@link PetaAnalitic.MapAdapter}.
        ...
        class ViewHolder extends RecyclerView.ViewHolder implements OnMapReadyCallback {
            ...
            /**
             * Displays a {@link PetaAnalitic.NamedLocation} on a
